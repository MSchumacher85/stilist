<x-main-layout>
    <x-slot:content>
        ...
        <section class="ftco-section ftco-discount img" style="background-image: url({{ Vite::asset('resources/images/bg_2.jpg') }});">
        ...
        <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url({{ Vite::asset('resources/images/bg_4.jpg') }});">
            <div class="overlay"></div>
            <div class="container">
