...
<html lang="en">
      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                      <div class="img mb-4"
                           style="background-image: url({{ Vite::asset('resources/images/person_1.jpg') }});"></div>
              ...
              <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                      <div class="img mb-4"
                           style="background-image: url({{ Vite::asset('resources/images/person_2.jpg') }});"></div>
                      <div class="info text-center">
              ...
              <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                      <div class="img mb-4"
                           style="background-image: url({{ Vite::asset('resources/images/person_3.jpg') }});"></div>
                      <div class="info text-center">
              ...
              <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                      <div class="img mb-4"
                           style="background-image: url({{ Vite::asset('resources/images/person_4.jpg') }});"></div>
                      <div class="info text-center">
  ...
  <section class="ftco-section ftco-discount img"
           style="background-image: url({{ Vite::asset('resources/images/bg_2.jpg') }});">
      <div class="overlay"></div>
      <div class="container">
          ...
          <div class="row">
              <div class="col-md-4 ftco-animate">
                  <a href="#" class="work-entry">
                      <img src="{{ Vite::asset('resources/images/work-1.jpg') }}" class="img-fluid"
              ...
              <div class="col-md-4 ftco-animate">
                  <a href="#" class="work-entry">
                      <img src="{{ Vite::asset('resources/images/work-2.jpg') }}" class="img-fluid"
                           alt="Colorlib Template">
                      <div class="info d-flex align-items-center">
                          <div>
                              <div class="icon mb-4 d-flex align-items-center justify-content-center">
              ...
              <div class="col-md-4 ftco-animate">
                  <a href="#" class="work-entry">
                      <img src="{{ Vite::asset('resources/images/work-3.jpg') }}" class="img-fluid"
                           alt="Colorlib Template">
                      <div class="info d-flex align-items-center">
                          <div>
                              <div class="icon mb-4 d-flex align-items-center justify-content-center">
                  ...
                  <div class="row">
                      <div class="col-md-3 ftco-animate">
                          <a href="#" class="partner-entry">
                              <img src="{{ Vite::asset('resources/images/partner-1.jpg') }}" class="img-fluid"
                                   alt="Colorlib Template">
                          </a>
                      </div>
                      <div class="col-md-3 ftco-animate">
                          <a href="#" class="partner-entry">
                              <img src="{{ Vite::asset('resources/images/partner-2.jpg') }}" class="img-fluid"
                                   alt="Colorlib Template">
                          </a>
                      </div>
                      <div class="col-md-3 ftco-animate">
                          <a href="#" class="partner-entry">
                              <img src="{{ Vite::asset('resources/images/partner-3.jpg') }}" class="img-fluid"
                                   alt="Colorlib Template">
                          </a>
                      </div>
                      <div class="col-md-3 ftco-animate">
                          <a href="#" class="partner-entry">
                              <img src="{{ Vite::asset('resources/images/partner-4.jpg') }}" class="img-fluid"
                                   alt="Colorlib Template">
                          </a>
                      </div>
                  </div>
  ...
  <section class="ftco-section ftco-counter img" id="section-counter"
           style="background-image: url({{ Vite::asset('resources/images/bg_4.jpg') }});">
      <div class="overlay"></div>
      <div class="container">
      ...
      <div class="container">
          ...
          <div class="row d-flex">
              <div class="col-md-4 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch">
                      <a href="blog-single.html" class="block-20"
                         style="background-image: url({{ Vite::asset('resources/images/image_1.jpg') }});">
                      </a>
              ...
              <div class="col-md-4 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch">
                      <a href="blog-single.html" class="block-20"
                         style="background-image: url({{ Vite::asset('resources/images/image_2.jpg') }});">
                      </a>
                      <div class="text py-4 d-block">
                          <div class="meta">
                              <div><a href="#">Sept 10, 2018</a></div>
              ...
              <div class="col-md-4 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch">
                      <a href="blog-single.html" class="block-20"
                         style="background-image: url({{ Vite::asset('resources/images/image_3.jpg') }});">
                      </a>
                      <div class="text py-4 d-block">
                          <div class="meta">
                              <div><a href="#">Sept 10, 2018</a></div>
  ...
  <script src="{{ Vite::asset('resources/js/jquery-migrate-3.0.1.min.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/popper.min.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/bootstrap.min.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/jquery.easing.1.3.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/jquery.waypoints.min.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/jquery.stellar.min.js') }}"></script>
  ...
  <script src="{{ Vite::asset('resources/js/bootstrap-datepicker.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/jquery.timepicker.min.js') }}"></script>
  <script src="{{ Vite::asset('resources/js/scrollax.min.js') }}"></script>
